...
model = tf.keras.models.Sequential([
    ...
    # Convolution 1
    keras.layers.Conv1D(filters=48, kernel_size=3, strides=2, activation="relu", input_shape=(540,3)),
    # output( 64, 269)
    keras.layers.BatchNormalization(),

    # Convolution 2
    keras.layers.Conv1D(filters=48, kernel_size=3, strides=2, activation="relu"),
    # # output( 64, 134)
    keras.layers.BatchNormalization(),

    ##Convolution 3
    keras.layers.Conv1D(filters=96, kernel_size=3, strides=2, activation="relu"),
    ##output( 64, 66)
    keras.layers.BatchNormalization(),
...
model.fit(X_train, y_train, epochs=50, batch_size=2**5, 
